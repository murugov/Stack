...
FILES = ErrDetect.cpp IsBadPtr.cpp main.cpp StackCtor.cpp StackDtor.cpp StackDump.cpp StackInit.cpp StackPop.cpp StackPush.cpp StackRealloc.cpp StackVerify.cpp

all:
	@echo "-----------------------------------------------------------------------------------------"
	g++ $(FLAGS) $(FILES) -I./headers -o output
	@echo "-----------------------------------------------------------------------------------------"
